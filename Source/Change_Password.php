...
<div class="col-sm-12">
                <div class="form-group">
                    ...
                    <input type="password" value="" class="form-control" name="text1" minlength="6" required="">
                </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="password" value="" class="form-control" name="text2" minlength="6"  required="">
                </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="password" value="" class="form-control" name="text3" minlength="6"  required="">
                </div>
                </div>
